...
namespace LagrangeProblem
{
    class _2_18
    {
        ...
        {
            return new Conditions(0, new Vector(component, 0.0));
        }
        ...
        {        
            ...
            UnknownCondProblem problem =
                new UnknownCondProblem(BuildConditions, ExtractComponents,
                    tLast, previousStartingPoint, nextStartingPoint, numOfEquations, f, Lambda);
